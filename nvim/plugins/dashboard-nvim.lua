    ...
    local opts = {
      ...
      config = {
        ...
        center = {
          ...
          { action = 'lua LazyVim.pick("oldfiles")()',                 desc = " Recent Files",    icon = "󰈢 ", key = "r" },
          { action = "cd ~/Gits | Neotree",                            desc = " Git Folder",      icon = "󰊢 ", key = "g" },
          { action = 'lua LazyVim.pick("live_grep")()',                desc = " Find Text",       icon = " ", key = "i" },
